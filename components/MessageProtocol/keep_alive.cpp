...
{
    wss_keep_alive_storage *keep_alive_storage = static_cast<wss_keep_alive_storage *>(arg);
    bool run_task = true;
...
wss_keep_alive_t wss_keep_alive_start(wss_keep_alive_config_t *config)
{
    ...
    wss_keep_alive_t keep_alive_storage = static_cast<wss_keep_alive_storage *>(calloc(1,
...
{
    client_fd_action_t client_fd_action = { .type = CLIENT_UPDATE,
                                            .fd = fd,
